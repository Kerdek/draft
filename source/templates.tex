...
of a substitution failure in a negated concept-id;
in the example below, does requires \tcode{!sad<typename T::type>} mean
...
\begin{codeblock}
  ...
  int i1 = f1(42);     // ambiguous, \tcode{!sad<T>} constraints are not formed from the same expression
