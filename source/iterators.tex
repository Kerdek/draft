...
\begin{itemize}
\item
\tcode{incrementable_traits<J>::difference_type}
if \tcode{iterator_traits<J>} names a specialization
generated from the primary template, and

\item
\tcode{iterator_traits<J>::difference_type} otherwise,
\end{itemize}
where \tcode{J} is \tcode{remove_cvref_t<I>}.
...
\begin{itemize}
\item
\tcode{indirectly_readable_traits<J>::value_type}
if \tcode{iterator_traits<J>} names a specialization
generated from the primary template, and

\item
\tcode{iterator_traits<J>::value_type} otherwise,
\end{itemize}
where \tcode{J} is \tcode{remove_cvref_t<I>}.
...
exposition-only \tcode{\placeholder{dereferenceable}} concept\iref{iterator.synopsis}.
\end{note}
